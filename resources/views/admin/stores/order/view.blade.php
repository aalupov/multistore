    ...
    <div class="content">
     ...
     @include('includes.success')
                         <div class="form-group row mb-0">
                               <a href="{{ route('adminStorePanelOrders.show', $id) }}">
      ...
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p class="card-text">
							...
							<p>
							  <b> Total amount: ${{ $total + $order->shipping_amount + $order->payment_fee}}</b>
							</p>		
                </p>
              </div>
            </div>
        ...
        <!-- /.row -->
					  ...
					  <hr>
				<form method="post" action="{{ route('adminStorePanelOrders.update', $order->id) }}" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
